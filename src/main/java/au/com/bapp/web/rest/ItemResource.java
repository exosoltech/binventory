...
import au.com.bapp.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link au.com.bapp.domain.Item}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ItemResource {
    ...
    private static final String ENTITY_NAME = "binventoryItem";
