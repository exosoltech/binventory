...
@RestController
@RequestMapping("/api/binventory-kafka")
public class BinventoryKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BinventoryKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BinventoryKafkaResource(KafkaProperties kafkaProperties) {
